...
from models import PrincipleChoice, DeliberationResponse, ConsensusResult, FeedbackResponse, get_all_principles_text
...
class DeliberationAgent(Agent):
    ...
    def __init__(self, 
        ...
        base_instructions = f"""
You are a rational agent participating in a deliberation about distributive justice principles.
...
def create_deliberation_agents(num_agents: int, models: Optional[List[str]] = None) -> List[DeliberationAgent]:
    """
    ...
    for i in range(num_agents):
        ...
        personality_traits = [
            "You tend to be more risk-averse and prefer safety nets.",
            "You are more utilitarian and focus on overall outcomes.",
            "You balance individual rights with collective welfare.",
            "You are particularly concerned with inequality and fairness.",
            "You focus on practical implementation of principles.",
            "You prioritize long-term societal stability.",
            "You emphasize individual opportunity and merit.",
            "You consider the psychological effects of different systems."
        ]
        
        custom_instructions = personality_traits[i % len(personality_traits)]
...
6. Ask about their confidence in their feedback (0-100%)
