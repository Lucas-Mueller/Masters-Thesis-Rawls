...
```bash
# Quick 3-agent test (takes ~2-3 minutes)
...
- Reduce `num_agents` or `max_rounds`
...
- **Storage**: 100MB+ for results storage
- **Network**: Stable internet for API calls
- **API Costs**: ~$0.10-$2.00 per experiment (varies by size)

## 📄 Citation

If you use this system in academic research:

```bibtex
@software{maai_distributive_justice,
  title={Multi-Agent Distributive Justice Experiment Framework},
  author={[Your Name]},
  year={2024},
...
- **Veil of Ignorance**: Philosophical thought experiment
- **Multi-Agent Systems**: AI agents in social scenarios
